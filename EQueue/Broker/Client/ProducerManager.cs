...
namespace EQueue.Broker.Client
{
    public class ProducerManager
    {
        ...
        private readonly ConcurrentDictionary<string, ProducerInfo> _producerInfoDict = new ConcurrentDictionary<string, ProducerInfo>();
        ...
        public void RegisterProducer(ITcpConnection connection,string producerId)
        {
            ...
            _producerInfoDict.AddOrUpdate(connectionId, key =>
            {
                var producerInfo = new ProducerInfo
                {
                    ...
                    HeartbeatInfo = new ClientHeartbeatInfo(connection) { LastHeatbeatTime = DateTime.Now }
                };
